...
class OrderService(private val orderRepository: OrderRepository) {
    ...
    fun create(userId: String, requestBody: Mono<CreateOrderRequest>): Mono<ResponseCode> {
        return requestBody
                .flatMap {
                    val menus = it.menus
    ...
    fun update(userId: String, requestBody: Mono<UpdateOrderRequest>): Mono<ResponseCode> {
        return requestBody
                .flatMap {
